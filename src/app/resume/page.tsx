  ...
  return (
    <main className="min-h-screen p-6">
      <div className="max-w-3xl mx-auto bg-white dark:bg-gray-900 rounded-lg shadow p-6">
        <h1 className="text-2xl font-bold mb-2">Currículo</h1>
        <p className="text-neutral-600 dark:text-neutral-400 mb-4">Segue o link para abrir o meu currículo em PDF (será aberto em nova aba).</p>
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          >
            Abrir currículo (Google Drive)
          </a>

          <Link href="/" className="inline-block px-4 py-2 text-sm ml-0 sm:ml-2">Voltar</Link>
        </div>
      </div>
    </main>
  )
