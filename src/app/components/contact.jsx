...
export default function contact() {
  ...
  return (
    <div>
      ...
      <footer className={`text-center ${styles.backgroundColor} ${styles.colorMain}`}>
            ...
            <form action="">
              <div
                ...
                <div className="relative md:mb-6" data-te-input-wrapper-init>
                  ...
                  <label
                    className={`pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-neutral-200 peer-data-[te-input-state-active]:-translate-y-[0.9rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-neutral-200 dark:peer-focus:text-neutral-200 ${styles.colorMain}`}
                  >Email address
                  </label>
                </div>
        ...
        <div
          className={`p-4 text-center ${styles.backgroundColor}`}>
          <span className={`${styles.colorMain}`}>© 2023 Copyright:
            <a href="#home"
            > Daniel Cerverizzo</a
            >
          </span>
