  ...
  return (
    <div>
      ...
      <p className="prose prose-neutral dark:prose-invert">
        I am a seasoned Software Development Engineer with an extensive background spanning over 10 years in crafting compelling user interfaces and elevating web applications. Presently, I serve as a Software Development Engineer at &nbsp;
...
-301 139 -34 -1 -79 -5 -100 -10z"/>
        ...
        &nbsp; specializing in the meticulous construction of UX/UI components using technologies such as&nbsp;
        ...
        And boasting proficiency and hands-on experience in frameworks like
      ...
      <div className="prose prose-neutral dark:prose-invert">
        <p>
          Throughout my career, I have excelled in designing user-centric features for web applications, collaborating seamlessly with design teams,
          and contributing significantly to support functions by enhancing communication. In the early stages of my career, I honed my problem-solving acumen while serving as a Junior, and since then,
          I have consistently prioritized and delivered effective solutions
        </p>
        <p className='mt-5'>
          My rich professional journey includes not only technical contributions but also the privilege of presenting at prominent tech community events.
          These engagements have allowed me to advocate for advancements in technology and share valuable insights within the dynamic realm of Front End development.
          Leveraging my adept public speaking skills, I effectively communicate with clients, superiors, and fellow technology enthusiasts, further solidifying my position as a seasoned and accomplished Software Development Engineer.
        </p>
      </div>
    </div>
  )
