  ...
  return (
    <div>
      ...
      <p className="prose prose-neutral dark:prose-invert">
        ...
        I am a seasoned Software Development Engineer with an extensive background spanning over 7 years in crafting compelling user interfaces and elevating web applications. Presently, I serve as a Software Development Engineer at 
